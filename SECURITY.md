...
- **Lossy platforms.** Most chat apps, social networks, and rich-text editors normalize, strip, or re-encode content. Many destroy the very bits the tool relies on. See `content/docs/limitations.mdx`.
